...
\name{\textbf{Nathan Aclander} \ \ \ \ \ \ \
      \textit{\href{https://aclander.com}{aclander.com}} \ \ \ \ \ \ \
      \textit{\href{mailto:nathan@aclander.com}{nathan@aclander.com}} \ \ \ \ \ \ \
      \textit{(949)-436-8945}}
\address{\ }
\address{\ }
...
\begin{resume}
 ...
 \section{\uppercase{Skills}}
	...
	\end{itemize}
    {\sl\textbf{Languages:}}\/
    Python, Java, Bash, Ruby, C, Emacs Lisp, C++, GO \\
    {\sl\textbf{Frameworks:}}\/
    ...
    \emph{Principal member of Technical Staff } --- Working in various areas of the Oracle Cloud. 
	From region build, region automation, networking automation, 
	and global service proxies. Responsible of designing and 
	leading the development of multiple new services and components.
...
IT support (software and hardware), network infrastructure support
	...
	\begin{itemize}
        \item \underline{\href{https://github.com/naclander/Calibre-Remarkable-Device-Driver-Plugin}
            {Calibre/Remarkable Tablet Plugin}}
            Designed a \href{https://calibre-ebook.com/}{Calibre} plugin to sync books 
	    from the Calibre ebook management system to a \href{https://remarkable.com/}{Remarkable Tablet}
