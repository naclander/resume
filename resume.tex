...
\name{\textbf{Nathan Aclander} \ \ \ \ \ \ \
      ...
      \textit{\href{mailto:nathan.aclander@gmail.com}{nathan.aclander@gmail.com}} \ \ \ \ \ \ \ \textit{(949) 436-8945}}
\address{\ }
\address{\ }
...
\begin{resume}
 ...
 \section{\uppercase{Skills}}
    ...
    \emph{Senior member of Technical Staff } --- Working on automating and improving new region builds.
	...
	develop next generation EC2 instances. I then worked on the EC2 Tools team
        provisioning and configuration systems.
